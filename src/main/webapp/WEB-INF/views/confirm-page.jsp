<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.binhhv.riment.constants.WebConstants" %>
...
<body>
<c:set var="q1" value="<%=WebConstants.q1 %>"></c:set>
<c:set var="q2" value="<%=WebConstants.q2 %>"></c:set>
<c:set var="q3" value="<%=WebConstants.q3 %>"></c:set>
<c:set var="q4" value="<%=WebConstants.q4 %>"></c:set>
...
<div class="container page-to-top">
	...
	<div class="row row-survey">
		...
		<div class="col-md-7 col-sm-12 col-xs-12 nopadding-left">
			...
			<c:choose>
				<c:when test="${not empty surveyObject.idsp1 }">
					<div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-row">
						1枚目 : ${surveyObject.idsp1 }
					</div>
				</c:when>
				<c:when test="${not empty surveyObject.idsp2 }">
					<div class="col-md-12 col-sm-12 col-xs-12">
						2枚目 : ${surveyObject.idsp2 }
					</div>
				</c:when>
			</c:choose>		
			</div>
	...
	<div class="row row-survey">
		...
		<div class="col-md-7 col-sm-12 col-xs-12 nopadding-left">
			<div class="row-right row nomargin">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<c:choose>
						<c:when test="${surveyObject.courses == 1 }">
							<div class="col-md-6 col-sm-6 col-xs-6">
						<img alt="a" src="${APP_CONTEXT }/resources/images/a.png"><br>
						<label>
							<form:radiobutton path="courses" value="1" checked="checked" />
							A賞（応募ID 2枚）
							キムワイプオリジナル
							BRUNOハイブリッド加湿器
							フォルテミストwhite
						...
						<c:when test="${surveyObject.courses == 2 }">
							<div class="col-md-6 col-sm-6 col-xs-6">
						<img alt="a" src="${APP_CONTEXT }/resources/images/b.png"><br>
						<label>
							<form:radiobutton path="courses" value="2" checked="checked" />
							B賞（応募ID 2枚）
							キムタオルオリジナル
							タイガーポータブルクーラー
							保温・保冷9.5L
						...
						<c:when test="${surveyObject.courses == 3 }">
							<div class="col-md-6 col-sm-6 col-xs-6">
						<img alt="a" src="${APP_CONTEXT }/resources/images/c.png"><br>
						<label>
							<form:radiobutton path="courses" value="3" checked="checked" />
							C賞（応募ID 1枚）
							オリジナルマグカップ4個セット
						</label>
					</div>
						</c:when>
						<c:when test="${surveyObject.courses == 4 }">
							<div class="col-md-6 col-sm-6 col-xs-6">
						<img alt="a" src="${APP_CONTEXT }/resources/images/d.png"><br>
						<label>
							<form:radiobutton path="courses" value="4" checked="checked" />
							D賞（応募ID 1枚）
							オリジナルトランプ
						</label>
					</div>
	...
	<div class="row row-survey">
		...
		<div class="col-md-7 col-sm-12 col-xs-12 nopadding-left">
			<div class="row-right row nomargin">
				...
				<c:forEach items ="${surveyObject.q1List }" var="q1item">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<c:out value="${Constants.getValue(q1,q1item) }" />
	...
	<div class="row row-survey">
		...
		<div class="col-md-7 col-sm-12 col-xs-12 nopadding-left">
			<div class="row-right row nomargin">
				<%-- <c:forEach items ="${surveyObject.q1List }" var="q1item"> --%>
					<div class="col-md-12 col-sm-12 col-xs-12">
						<c:out value="${Constants.getValue(q2,surveyObject.q2) }" />
	...
	<div class="row row-survey">
		...
		<div class="col-md-7 col-sm-12 col-xs-12 nopadding-left">
			<div class="row-right row nomargin">
				<%-- <c:forEach items ="${surveyObject.q1List }" var="q1item"> --%>
					<div class="col-md-12 col-sm-12 col-xs-12">
						<c:out value="${Constants.getValue(q3,surveyObject.q3) }" />
						<c:if test="${not empty surveyObject.otherq3 }">
							 : <c:out value="${surveyObject.otherq3 }"></c:out>
						</c:if>
					</div>
				<%-- </c:forEach> --%>
				<%-- <div class="col-md-6 col-sm-6 col-xs-12">
	...
	<div class="row row-survey">
		...
		<div class="col-md-7 col-sm-12 col-xs-12 nopadding-left">
			<div class="row-right row nomargin">
				<c:forEach items ="${surveyObject.q4List }" var="q4item">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<c:out value="${Constants.getValue(q4,q4item) }" />
					</div>
				</c:forEach>
				<%-- <div class="col-md-6 col-sm-6 col-xs-12">
					<label>
...
●日本製紙クレシア株式会社は､キャンペーン詳細確認に伴う使用機器･通信における障害､損傷についての責任を負いかねますので、ご了承下さい。</textarea>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;margin-top: 10px;">
			...
			<input type="image" src="${APP_CONTEXT }/resources/images/titleconf11.png" alt="oubo_btn" width="124" height="40" onclick="onBack();return false;">&nbsp;
                                                            
                                                            <input type="image" src="${APP_CONTEXT }/resources/images/title33.png" alt="oubo_btn" width="124" height="40"></input>
		</div>
	</div>
